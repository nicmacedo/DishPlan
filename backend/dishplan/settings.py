...
WSGI_APPLICATION = "dishplan.wsgi.application"
ASGI_APPLICATION = "dishplan.asgi.application"
...
SPECTACULAR_SETTINGS = {
    "TITLE": "DishPlan API",
    "DESCRIPTION": "API do sistema DishPlan",
    "VERSION": "0.1.0",
...
if config("DJANGO_SECURE_SSL", default=False, cast=bool):
